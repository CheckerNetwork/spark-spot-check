...
export default class Spark {
  ...
  async executeSpotCheck(retrieval, stats, dagScope = "block") {
  ...
  async fetchCAR(protocol, address, cid, stats, dagScope = "block") {
  ...
  async nextRetrieval() {
    ...
    await this.executeSpotCheck(retrieval, stats)
